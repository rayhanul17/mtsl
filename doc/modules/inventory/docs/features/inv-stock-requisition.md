...
Request stock between stores. Header, details, bulk details, action-flow, report.

## Entry

| Kind | Value |
|------|-------|
| Routes | `inventory-module/inventory-stock-requisition`, `inventory-module/inventory-stock-requisition-report/:requisitionId` |
